      ...
      <div className='hero'>
            ...
            <div className='biodata-container'>
              ...
              <div className="intro-container">
                ...
                <p className='intro-sentences'>Fresh graduated SMA yang bermotivasi tinggi untuk menjadi <b>Front End Developer</b> dan keinginan untuk terus berkembang di dunia <b>Web Developer</b>.</p>
